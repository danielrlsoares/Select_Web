		...
		<table class="consulta">
			...
			<tbody>
				...
				<tr class="consulta_row">
					...
					<td><button class="float-btn" id="local" onclick="window.location.href = 'endereco.php?id=<?= $dados['fk_cod_endereco'] ?>'"><img src="imagens/local.png" class="icon"></button></td>
				</tr>
			</tbody>
			<tr><td colspan=6><button class="cadastrar" onclick= "window.location.href = 'Catadores.php?id=<?= $dados['cod_associacao'] ?>'">Catadores</button></td></tr>
			<?php 
			pg_close($connect);
			?>
		</table>
